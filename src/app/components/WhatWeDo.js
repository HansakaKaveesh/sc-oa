export default function WhatWeDo() {
  ...
  return (
    <section id="whatwedo" className="relative py-24 bg-gradient-to-b from-gray-50 via-white to-gray-50">
          ...
          {activities.map((a, i) => (
            ...
            >
              ...
              <div className="relative overflow-hidden h-56">
                ...
                <h3 className="absolute bottom-3 left-3 text-white text-lg font-semibold tracking-wide drop-shadow-lg">
                  {a.title}
                </h3>
              </div>
              ...
              <div className="p-5 text-left">
                <p className="text-gray-700 leading-relaxed text-sm">{a.text}</p>
              </div>
            </div>
          ))}
        </div>
