...
const photos = [
  {
    id: "ella-01",
    src: "/gallery/ella-01.jpg",
    alt: "Sunrise view from Ella Rock",
    category: "Hiking",
  ...
  {
    id: "beach-01",
    src: "/gallery/beach-clean-01.jpg",
...
function GalleryCard({ photo, delay = 0, onOpen }) {
  ...
  return (
    <button
      type="button"
      onClick={onOpen}
      className="group relative rounded-2xl overflow-hidden border border-gray-100 bg-white/80 backdrop-blur-sm shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-300"
      data-aos="fade-up"
...
export default function GalleryPage() {
  ...
  const headerBgUrl = "https://images.pexels.com/photos/547114/pexels-photo-547114.jpeg";
